...
''',
    ...
    def test_app_html_contains_core_mount_points(self):
        ...
        self.assertIn('data-finding-filter="statusConclusion"', html)
        self.assertIn('data-finding-filter="vulnerabilityType"', html)
        self.assertIn('data-finding-filter="manualReview"', html)
        self.assertIn('function filteredFindings(', html)
        self.assertIn('function findingMatchesFilters(', html)
        self.assertIn('const navigationFindings = filteredFindings();', html)
        self.assertIn('const findings = filteredFindings();', html)
        self.assertIn('return filteredFindings().findIndex', html)
        self.assertIn('筛选集合', html)
        ...
        self.assertIn('floatingManualReviewKey: null', html)
        self.assertIn('class="floating-manual-review"', html)
        self.assertIn("renderManualReviewCard(finding, 'floating')", html)
        self.assertIn('function bindManualReviewControls(root)', html)
        self.assertIn('bindManualReviewControls(sticky)', html)
        self.assertIn("state.floatingManualReviewKey = state.floatingManualReviewKey === key ? null : key", html)
        self.assertIn('state.expandedManualReviewKey = null', html)
        self.assertNotIn("card.scrollIntoView({ behavior: 'smooth', block: 'center' })", html)
